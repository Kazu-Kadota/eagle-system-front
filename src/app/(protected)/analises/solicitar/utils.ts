...
import { statusWithStates } from '@/components/AnalysisTypeSelect';
...
export const preparePersonData = (
  ...
  birth_date: data.birth_date
    ? customDayJs(data.birth_date, 'DD/MM/YYYY').toISOString()
    : '',
  expire_at_cnh: data.expire_at_cnh
    ? customDayJs(data.expire_at_cnh, 'DD/MM/YYYY').toISOString()
    : '',
});
